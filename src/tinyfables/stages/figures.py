    ...
    try:
        ...
        fig.text(
            ...
            (
                ...
                f"no aug: {perplexity['no-aug']:.3f}. "
                "Held-out = five eval-only templates."
            ),
            fontsize=7.5,
        )
        fig.text(
        ...
        fig.subplots_adjust(
            left=0.08, right=0.98, bottom=0.22, top=0.80, wspace=0.20
        )
        fig.savefig(
            png_path,
            dpi=200,
    ...
    try:
        ...
        fig.text(
            ...
            (
                ...
                f"{rm_prov['reward_manifest_sha256'][:12]} · "
                "all committed points shown"
            ),
            fontsize=6.5,
            color="#444444",
        )
